					...
					<div className="ProjectIntroduction__ProjectIntroductionWrapper-sc-1o2ojgb-1 bnFLKn">
						<div className="ProjectIntroduction__ProjectOutline-sc-1o2ojgb-2 jbdzfG">
							<div className="ProjectIntroduction__ProjectOutlineInner-sc-1o2ojgb-3 fFIyMZ">
								<a href="https://tumblbug.com/discover?category=fashion_goods"><span className="ProjectIntroduction__ProjectCategory-sc-1o2ojgb-4 fNvuiJ">패션잡화</span></a>
								<h1 className="ProjectIntroduction__ProjectTitle-sc-1o2ojgb-5 cWQlcy">한국 고유의 美를 담다 : 백제인의 ‘삶’이 담긴 에코백</h1>
								<div className="ProjectIntroduction__Creators-sc-1o2ojgb-6 fsPnxP">
									<span className="ProfileImg-sc-1vio56c-0 hxdMup"></span><a className="ProjectIntroduction__CreatorName-sc-1o2ojgb-7 jDbkqK" href="https://tumblbug.com/u/darotajejetaroke/projects" target="_blank" rel="noopener noreferrer">담_백</a>
								</div>
							</div>
						</div>
						<div className="ProjectIntroduction__ProjectIntroductionMainColumn-sc-1o2ojgb-8 ZOwbJ">
							    <figure className="ProjectIntroduction__ProjectCoverImageFigure-sc-1o2ojgb-9 fUBtAC"><img className="ProjectIntroduction__ProjectCoverImage-sc-1o2ojgb-11 hGsHpc" src="./커뮤니티_files/0cd22a14-9f63-46fc-8266-db82b6abcd7f.jpg" alt="프로젝트 커버 이미지" /></figure>
							</div>
								...
								<div className="ProjectPage__MainColumnInner-f3cisk-4 kGPPtA">
									<div>
										<div className="Card-sc-1sgtmvk-0 gBrdMC">
											<div className="CommunityNewPost__CommunityNewPostWidget-sc-13rcz93-0 gXVgCu">
												<div className="CommunityNewPost__LeftColumn-sc-13rcz93-1 fVfKuI">
													<span className="ProfileImg-sc-1vio56c-0 cNVfcL"></span>
										...
										<div className="Community__Posts-sc-1o9947p-0 kEeUNF">
											<div className="PostFilter__FilterWrapper-sc-73iosc-0 evTQgg">
												<div className="PostFilter__FilterButton-sc-73iosc-1 dQQULI">
													모든 게시글
												</div>
											
												&nbsp;
												
												<div className="PostFilter__FilterButton-sc-73iosc-1 jXFesk">
													창작자 업데이트
												</div>
											</div>
											<div className="CommunityPostSummaryCard__PostSummaryCardWrapper-sc-3xh5y6-0 jyqxKO">
												<div className="Card-sc-1sgtmvk-0 gBrdMC">
													<div className="CommunityPostSummaryCard__MetaWrapper-sc-3xh5y6-1 bwIkbu">
														<div className="CommunityPostSummaryCard__Meta-sc-3xh5y6-3 dcqdFa">
															<div className="CommunityPostSummaryCard__MetaInner-sc-3xh5y6-4 dOOkIY">
																<span className="ProfileImg-sc-1vio56c-0 lnQxqP"></span>
																<div className="CommunityPostSummaryCard__UserProfile-sc-3xh5y6-5 kekUEM">
																	<div className="CommunityPostSummaryCard__AuthorWrapper-sc-3xh5y6-6 toZNR">
																		<div className="CommunityPostSummaryCard__AuthorFullname-sc-3xh5y6-7 sKdTV">
																			줘닝
																		</div>
																	</div>
																	<span>
																...
																<div className="CommunityPostSummaryCard__Notice-sc-3xh5y6-10 bIvack">
																</div>
															</div>
														</div>
													</div>
														...
														<div>
															<div className="CommunityPostSummaryCard__Contents-sc-3xh5y6-14 gnqHud">
																<div className="storyContent">
																	가방에 물건 넣은모습을 보고싶은데 영상이나 이미지 추가는 어려우실까용??
																</div>
															</div>
														</div>
													</div>
									...
									<div className="Card-sc-1sgtmvk-0 gBrdMC">
										<div className="CreatorCard__CreatorCardInner-sc-1ifohey-0 iubrbI">
											...
											<div className="CreatorCard__CreatorProfile-sc-1ifohey-2 buiMEG">
												<span className="ProfileImg-sc-1vio56c-0 Acxpj"></span><a href="https://tumblbug.com/u/darotajejetaroke/projects"><span className="CreatorCard__CreatorName-sc-1ifohey-3 ksslMx">담_백</span></a>
											</div>
											<div className="CreatorCard__CreatorBiography-sc-1ifohey-4 kTXqqU">
												담_백은 한국의 고대, 백제의 문화에 관심이 많은 청춘들이 모여 만든 브랜드입니다. 각자 다른 삶을 살아왔지만 ‘소외된 전통을 발굴’하자는 공통된 마음으로 함께 일하고 있습니다. 담_백이라는 팀명은 ‘백제를 담다’ 와 ‘담백하다’의 두 가지 의미를 담고 있습니다.
											</div>
